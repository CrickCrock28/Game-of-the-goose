...
#define SCELTA_MENU_PARTITE_SALVATE 2 // Scelta corrispondende al menu delle partite salvate
...
int main(void) {
    ...
    if (verificare_esistenza_tutti_file() == true) {
		...
		do {
			...
			// Se l'utente sceglie di aprire il menu partite salvate
				...
				if (leggere_partita_presente_record_partite_salvate(salvataggi) == true) {
