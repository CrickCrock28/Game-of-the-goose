...
void stampare_giocatore_classificato(record_classificato giocatore_classificato){
    ...
    printf("nome: %s ,", leggere_nome_giocatore_record_classificato(giocatore_classificato));
    //stampare il numero di tiri di un classificato
    printf("tiri: %d\n", leggere_tiri_record_classificato(giocatore_classificato));
